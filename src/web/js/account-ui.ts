...
function setFormMessage(elementId: string, message: string, isError = false): void {
...
function clearFormMessage(elementId: string): void {
  const el = document.getElementById(elementId);
...
export function initAccountUI({ toast, render }: AccountUIDeps): void {
  ...
  document.getElementById("registerBtn")?.addEventListener("click", async () => {
    ...
    const nicknameEl = document.getElementById("registerNickname") as HTMLInputElement | null;
  ...
  document.getElementById("showLoginFormBtn")?.addEventListener("click", () => {
    ...
    const nick = document.getElementById("loginNickname") as HTMLInputElement | null;
    const dev = document.getElementById("loginDeviceCode") as HTMLInputElement | null;
    if (nick) nick.value = "";
    if (dev) dev.value = "";
  ...
  document.getElementById("loginBtn")?.addEventListener("click", async () => {
    ...
    const nickEl = document.getElementById("loginNickname") as HTMLInputElement | null;
    const devEl = document.getElementById("loginDeviceCode") as HTMLInputElement | null;
  ...
  document.getElementById("syncBothBtn")?.addEventListener("click", async () => {
    ...
    const btn = document.getElementById("syncBothBtn") as HTMLButtonElement | null;
  ...
  document.getElementById("loginFormModal")?.addEventListener("click", (e) => {
    if ((e.target as HTMLElement).id === "loginFormModal") hideModal("loginFormModal");
  });
  document.getElementById("registerFormModal")?.addEventListener("click", (e) => {
    if ((e.target as HTMLElement).id === "registerFormModal") hideModal("registerFormModal");
  });

...
export const STORAGE_KEY_APP_VERSION = "pig_app_version_v1";
...
// ---- Data URLs ----
export const DATA_URL_BY_LANG: Record<string, string> = {
  zhs: "/data/pigs_full_zhs.json",
  zht: "/data/pigs_full.json",
};

// ---- API Base ----
export const API_BASE = ""; // 相对路径

// ---- Image ----
export const IMG_BASE = "/img/pigs/";

// ---- Labels ----
export const METHOD_LABELS: Record<AcquireMethod | "feed_special", string> = {
  shop: "商店进货",
  hunt: "狩猎",
  hunt_event: "活动狩猎",
  breed: "配种",
...
export const HUNT_SITES: Record<number, string> = {
  3: "草原 (普通券)",
  4: "山林 (普通券)",
  5: "草原 (稀有券)",
  6: "山林 (稀有券)",
...
export const FEED_LABELS: Record<number, string> = {
  1: "杂粮",
  2: "素食MIX",
  3: "红薯",
  4: "玉米",
...
export const BOOK_COLOR_TEXT: Partial<Record<number, string>> = {
  1: "肉色",
  2: "灰色",
  3: "米色",
  4: "粉红",
...
export const COLOR_TEXT: Partial<Record<number, string>> = {
  1: "肉色",
  2: "灰色",
  3: "米色",
  4: "粉红",
...
export const BLEED_TYPE_TEXT: Record<string, string> = {
  "1": "猪猪广场交配",
  "0": "猪猪广场交配 [不能租借公猪]",
  "-1": "猪猪广场交配 [隐藏, 不能租借公猪]",
  "3": "系统图交换所",
...
export const COLOR_DOT_PROG: Record<string, string> = {
  "肉色": "#ffcba4",
  "灰色": "#9e9e9e",
  "米色": "#a0522d",
  "粉红": "#ffb6c1",
...
export const RAISING_FLOORS: Record<RaisingFloor, { label: string; multiplier: number }> = {
...
// ---- Auction ----
export const AUCTION_PAGE_SIZE = 30;
export const LIMITDATE_OFFSET_HOURS = 8;
export const WEIGHT_OFFSET_KG = 22;
export const ADULT_OFFSET_KG = WEIGHT_OFFSET_KG + 98;

export const COLOR_TO_P: Record<string, string> = {
  "肉色": "700",
  "灰色": "704",
  "米色": "708",
  "粉色": "712",
...
export const FOOD_LABELS: Record<number, string> = {
  0: "🍽️ 不挑食",
  1: "🍽️ 有点挑食",
  2: "🍽️ 挑食",
};
...
export const SEX_CLS: Record<number, string> = {
  0: "sex male",
  1: "sex female",
};

// ---- Export ----
export const EXPORT_TYPE = "pigfarm-helper-backup";
